...
/// \cond CLASSIMP
ClassImp(AliDplusCharmFractionIPfitter);
/// \endcond

AliDplusCharmFractionIPfitter::AliDplusCharmFractionIPfitter()
  :TObject()
  ,fMCPromptSparse(0x0)
  ,fMCTrueFDSparse(0x0)
  ,fMCRecoFDSparse(0x0)
...
//_________________________________________________________________________________
void AliDplusCharmFractionIPfitter::GetSignal(Int_t rebin, Int_t funcsig, Int_t funcbkg, Double_t min, Double_t max, Int_t sovert)
{
  if(!fDataSparse) {
...
//_________________________________________________________________________________
void AliDplusCharmFractionIPfitter::CheckSideBandsImpParDist(Int_t nSigmaWidth)
{
  ResetAxes(fDataSparse);
...
void AliDplusCharmFractionIPfitter::PrefitOnPrompt(Double_t d0minPrompt, Double_t d0maxPrompt)
{
  ...
  TF1* ImpParPromptFunc = new TF1("ImpParPromptFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParPrompt,d0minPrompt,d0maxPrompt,5,"AliDplusCharmFractionIPfitter","FunctionImpParPrompt");
...
void AliDplusCharmFractionIPfitter::PrefitOnFD(Double_t d0minFD, Double_t d0maxFD)
{
  ...
  if(fFDType==kConvolution) {
    TF1* ImpParTrueFDFunc = new TF1("ImpParTrueFDFunc",this,&AliDplusCharmFractionIPfitter::FunctionTrueImpParFD,d0minFD,d0maxFD,5,"AliDplusCharmFractionIPfitter","FunctionTrueImpParFD");
    ...
    ImpParRecoFDFunc = new TF1("ImpParRecoFDFunc",this,&AliDplusCharmFractionIPfitter::FunctionRecoImpParFD,-1000,1000,1,"AliDplusCharmFractionIPfitter","FunctionRecoImpParFD");
...
void AliDplusCharmFractionIPfitter::PrefitOnBkg(Double_t d0minBkg, Double_t d0maxBkg, Bool_t printSB)
{
  ...
  if(fBkgType==kSingleGaussExpo) {
    ...
    ImpParBkgFunc = new TF1("ImpParBkgFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParBkg,d0minBkg,d0maxBkg,10,"AliDplusCharmFractionIPfitter","FunctionImpParBkg");
    ImpParBkgFunc->SetLineColor(kMagenta);
    ...
    ImpParBkgFunc = new TF1("ImpParBkgFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParBkg,d0minBkg,d0maxBkg,6,"AliDplusCharmFractionIPfitter","FunctionImpParBkg");
    ImpParBkgFunc->SetLineColor(kMagenta);
...
void AliDplusCharmFractionIPfitter::PrefitStep(Double_t d0minPrompt, Double_t d0maxPrompt, Double_t d0minFD, Double_t d0maxFD, Double_t d0minBkg, Double_t d0maxBkg)
{
...
//_______________________________________________________________________________
void AliDplusCharmFractionIPfitter::GenerateEntries(Bool_t background, Int_t gentype, Int_t treeOrhisto)
{
  if(!fMCPromptSparse) {
    cerr << "MC Prompt THnSparse not set!!" << endl;
    return;
  ...
  if(gentype==kFromFunc) {
    ...
    PromptFunc = new TF1("PromptFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParPrompt,-1000,1000,5,"AliDplusCharmFractionIPfitter","FunctionImpParPrompt");
    PromptFunc->SetParameters(fPromptFractionGauss,fPromptMean,fPromptSigmaMC,fPromptLambda,1.);
    if(fFDType==kConvolution) {
      RecoFDFunc = new TF1("RecoFDFunc",this,&AliDplusCharmFractionIPfitter::FunctionRecoImpParFD,-1000,1000,1,"AliDplusCharmFractionIPfitter","FunctionRecoImpParFD");
    ...
    if(fBkgType==kSingleGaussExpo) {
      BkgFunc = new TF1("BkgFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParPrompt,-1000,1000,5,"AliDplusCharmFractionIPfitter","FunctionImpParPrompt");
...
//_________________________________________________________________________________
void AliDplusCharmFractionIPfitter::FitTree(Double_t d0min, Double_t d0max, Bool_t print)
{
  if(fSig==0)
    GetSignal();
  if(fPromptSigmaMC==0)
  ...
  TF1* ImpParFitFunction = new TF1("ImpParFitFunction",this,&AliDplusCharmFractionIPfitter::FitFunction,d0min,d0max,2,"ImpParFitFunction","FitFunction");
  Int_t nfreepars=2;
...
void AliDplusCharmFractionIPfitter::FitHisto(Double_t d0min, Double_t d0max, Bool_t print)
{
  if(fSig==0)
    GetSignal();
  if(fPromptSigmaMC==0)
...
void AliDplusCharmFractionIPfitter::GetPromptFractionWithIPCut(Double_t d0cut, Double_t &promptfracd0cut, Double_t &err, Bool_t genfrac)
{
  TF1* PromptFunc = new TF1("PromptFunc",this,&AliDplusCharmFractionIPfitter::FunctionImpParPrompt,-1000,1000,5,"AliDplusCharmFractionIPfitter","FunctionImpParPrompt");
  ...
  if(!genfrac) {
    ...
    if(fFDType==kConvolution) {
      TF1* RecoFDFuncSigmaDer = new TF1("RecoFDFuncSigmaDer",this,&AliDplusCharmFractionIPfitter::RecoFDSigmaDerivative,-1000,1000,1,"AliDplusCharmFractionIPfitter","RecoFDSigmaDerivative");
...
Double_t AliDplusCharmFractionIPfitter::Gauss(Double_t d0,Double_t mean,Double_t sigma)
{
  return TMath::Gaus(d0,mean,sigma,kTRUE); //kTRUE means that is normalised
}

//______________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::ExpoDouble(Double_t d0, Double_t mean, Double_t lambda)
{
  return 1./(2.*lambda)*TMath::Exp(-TMath::Abs(d0-mean)/lambda);
}

//______________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::FunctionImpParPrompt(Double_t* x, Double_t* par)
{
  Double_t d0 = x[0];
...
//______________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::FunctionImpParBkg(Double_t* x, Double_t* par)
{
...
//_________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::Convolution(Double_t x, Double_t xmin, Double_t xmax, Int_t nstpdf)
{
...
//_________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::FitFunction(Double_t* x, Double_t *par)
{
...
//_________________________________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::GaussSigmaDerivative(Double_t *d0,Double_t *pars)
{
  Double_t d00 = d0[0];
...
//_________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::ConvolutionSigmaDerivative(Double_t x, Double_t xmin, Double_t xmax, Int_t nstpdf)
{
...
//_________________________________________________________________________
Double_t AliDplusCharmFractionIPfitter::RecoFDSigmaDerivative(Double_t *d0, Double_t *pars)
{
  Double_t d00=d0[0];
...
//_________________________________________________________________________
TH1F* AliDplusCharmFractionIPfitter::GetPtreweightedHisto(THnSparseF* sparse, Int_t meson)
{
  ResetAxes(sparse);
...
//___________________________________________________________________________________
void AliDplusCharmFractionIPfitter::RebinVariableWidth()
{
  Int_t bincounter=0;
...
//__________________________________________________________________________________
void AliDplusCharmFractionIPfitter::ResetAxes(THnSparseF* sparse)
{
...
//___________________________________________________________________________________
TH1F* AliDplusCharmFractionIPfitter::GetSidebandsDist(Bool_t printSB)
{
  ResetAxes(fDataSparse);
  SetPtRange(fDataSparse);
...
void AliDplusCharmFractionIPfitter::SetPtRange(THnSparseF* sparse)
{
...
//_______________________________________________________________________________________
void AliDplusCharmFractionIPfitter::SetMassRange(THnSparseF* sparse)
{
