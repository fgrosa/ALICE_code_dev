#ifndef AliDplusMassd0fitter_H
#define AliDplusMassd0fitter_H
/// \class AliDplusMassd0fitter
...
class AliDplusMassd0fitter : public TObject {
  
public:
  AliDplusMassd0fitter();
  ~AliDplusMassd0fitter();
...
private:
  ...
  /// \cond CLASSDEF
  ClassDef(AliDplusMassd0fitter,1);
  /// \endcond
};
#endif //AliDplusMassd0fitter
