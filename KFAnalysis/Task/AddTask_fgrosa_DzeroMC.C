AliAnalysisTask *AddTask_fgrosa_DzeroMC() {
  ...
  task->SetLooseCuts(topoloosecuts,mindaupt,ptlims,cospmin,decLmin,NdecLmin,sigvtxmax,chimax,PVchimax);
  ...
  TString outputfile = "fgrosa_Dzero_KF_MC.root";
