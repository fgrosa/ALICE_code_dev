...
void makeInputAliAnalysisTaskSEDplusPP(){
 ...
 //  gSystem->SetIncludePath("-I. -I$ROOTSYS/include -I$ALICE_ROOT -I$ALICE_ROOT/include -I$ALICE_ROOT/ITS -I$ALICE_ROOT/TPC -I$ALICE_ROOT/CONTAINERS -I$ALICE_ROOT/STEER -I$ALICE_ROOT/TRD -I$ALICE_ROOT/macros -I$ALICE_ROOT/ANALYSIS -I$ALICE_ROOT/PWG3 -I$ALICE_ROOT/PWG3/vertexingHF -I$ALICE_ROOT/PWG3/vertexingH/macros -g"); 
  ...
  /*    Cut list                                                
    ...
    3			"d0K [cm]",                                 
    4			"d0Pi [cm]",                                
    5			"dist12 [cm] dist vertice primario e vertice di 2 tracce",                              
    6			"sigmavert [cm]",                          
    7			"decLen [cm]",                             
    8			"ptMax [GeV/c]",                            
    9			"cosThetaPoint",                            
    10			"Sum d0^2 (cm^2)",                         
    11			"dca [cm] dca tra coppie di tracce",                                 
    12			"decLen XY [GeV]",               
    13			"costhetapoinXY";             
    */
    // Float_t cutsArrayDplustoKpipi[14]={0.2,0.3,0.3,0.,0.,0.01,0.06,0.02,0.,0.7,0.,10000000000.,0.,-1.}; quelli con cui vengono generate
   ...
   // esdTrackCuts->SetClusterRequirementITS(AliESDtrackCuts::kSPD,AliESDtrackCuts::kFirst);
    ...
    ic=6;//sigv
    for(Int_t ipt=0;ipt<nptbins;ipt++){
      anacutsval[ic][ipt]=0.034;
    }
    anacutsval[ic][0]=0.03;
    anacutsval[ic][1]=0.03;
    anacutsval[ic][8]=0.034;
    anacutsval[ic][9]=0.034;
    anacutsval[ic][10]=0.034;   
    anacutsval[ic][11]=0.066;             
    anacutsval[ic][12]=0.066;
    anacutsval[ic][13]=0.088;
    anacutsval[ic][14]=0.03;

    ic=7;   //distprimsec //non era DecL? forse da rimuovere...
    for(Int_t ipt=0;ipt<nptbins;ipt++){
      anacutsval[ic][ipt]=0.04;
    }
    anacutsval[ic][0]=0.0;
    anacutsval[ic][1]=0.0;
    anacutsval[ic][8]=0.05;
    anacutsval[ic][9]=0.13;
    anacutsval[ic][10]=0.09;   
    anacutsval[ic][11]=0.2;           
    anacutsval[ic][12]=0.14;
    anacutsval[ic][13]=0.05;
    ...
    anacutsval[ic][8]=5.6;
    anacutsval[ic][9]=5.6;
    anacutsval[ic][10]=5.6;   
    anacutsval[ic][11]=2;
    anacutsval[ic][12]=11;
    anacutsval[ic][13]=6.5;
    anacutsval[ic][14]=5;
    anacutsval[ic][15]=5; 
    */
    ic=13;
    for(Int_t ipt=0;ipt<nptbins;ipt++){
      anacutsval[ic][ipt]=0.97;//0.99
    }
    /*
    anacutsval[ic][0]=0.995;
    anacutsval[ic][1]=0.995;   
    */
    ...
    analysiscuts->SetMaxPtStrongPid(2);
    ...
    //per dati deccommentare ConfigurePileupCuts e SetTriggerMask e mettere 1 in SetOptPileup
    analysiscuts->SetOptPileup(0);    
    ...
    TFile* fout=new TFile("DplustoKpipiCutspPbMC_CutVar.root","recreate");   
    fout->cd();
    analysiscuts->Write();
