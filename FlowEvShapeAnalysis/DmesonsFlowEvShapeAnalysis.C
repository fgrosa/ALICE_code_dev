...
//to be set
//input file name
const TString infilename="$HOME/ALICE_WORK/AnalysisPbPb2015/v2/DplusFlow/AnalysisResults.root";
const TString suffix="_3050_d0Cut_TPC";//"_3050_CentralCuts_TPC";
...
const Double_t PtLims[nPtLims] = {2.,36.};
