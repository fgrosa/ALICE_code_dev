...
void RunAnalysisAODVertexingDplusTHnSmod(Bool_t fUseMC = kFALSE)
{
    //
    ...
    gROOT->LoadMacro("AliAnalysisTaskSEDplusTHnSmod.cxx++g");
    gROOT->LoadMacro("AddTaskDplusTHnSmod.C");
    ...
    AliAnalysisTaskSEDplusTHnSmod *task1 = AddTaskDplusTHnSmod(1,0,20,0,kTRUE,kFALSE,kFALSE,"020_kINT7","alien:///alice/cern.ch/user/f/fgrosa/DplustoKpipiCuts_020_loose_kINT7_NoFlat.root","AnalysisCuts",0);
...
AliAnalysisGrid* CreateAlienHandler(TString pluginmode="test",Bool_t useParFiles=kFALSE, Bool_t fUseMC)
{
    ...
    plugin->SetAliPhysicsVersion("vAN-20160914-1");
...
//        totruns += AddGoodRuns(plugin,"LHC15o",""); // specify LHC period
    ...
    plugin->SetGridWorkingDir("Dplus_PbPb_LooseCuts_sparsemod_cent");
    // Name of executable

    plugin->SetExecutable("Dplus_PbPb_LooseCuts_sparsemod_cent.sh");
    //    plugin->SetAnalysisSource("AliAnalysisTaskSEDplus_mio.cxx");


    // Declare alien output directory. Relative to working directory.
    plugin->SetGridOutputDir("Dplus_PbPb_LooseCuts_sparsemod_cent"); // In this case will be $HOME/work/output
    // Declare the analysis source files names separated by blancs. To be compiled runtime
    // using ACLiC on the worker nodes.
    // Declare all libraries (other than the default ones for the framework. These will be
    // loaded by the generated analysis macro. Add all extra files (task .cxx/.h) here.
    plugin->SetAnalysisSource("AliAnalysisTaskSEDplusTHnSmod.cxx");
    gROOT->ProcessLine(".L AliAnalysisTaskSEDplusTHnSmod.cxx+g");
    plugin->SetAdditionalLibs("libPWGflowBase.so libPWGflowTasks.so libPWGHFbase.so libPWGHFvertexingHF.so AliAnalysisTaskSEDplusTHnSmod.h AliAnalysisTaskSEDplusTHnSmod.cxx");
